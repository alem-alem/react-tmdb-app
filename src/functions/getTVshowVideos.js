...
const getTVshowVideo = async function(tvID){
  try{
    const response = await fetch(`https://api.themoviedb.org/3/tv/${tvID}/videos?api_key=19bdcbea0c866cc82a107ad48bb3bf5d&language=en-US`,{
      method: 'GET',
